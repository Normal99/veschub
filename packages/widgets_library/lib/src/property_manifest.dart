...
const List<PropertyMeta> _gauge = [
  ...
  PropertyMeta(key: 'showCenterText', minLevel: CapabilityLevel.basic, label: 'Center text', safe: true),
  PropertyMeta(key: 'centerValue', minLevel: CapabilityLevel.advanced, label: 'Center value'),
  PropertyMeta(key: 'centerUnit', minLevel: CapabilityLevel.basic, label: 'Center unit', safe: true),
  PropertyMeta(key: 'subLabel', minLevel: CapabilityLevel.basic, label: 'Sub-label', safe: true),
  PropertyMeta(key: 'showTickLabels', minLevel: CapabilityLevel.basic, label: 'Tick labels', safe: true),
  PropertyMeta(key: 'innerValue', minLevel: CapabilityLevel.advanced, label: 'Inner ring value'),
  PropertyMeta(key: 'innerMin', minLevel: CapabilityLevel.advanced, label: 'Inner ring min'),
  PropertyMeta(key: 'innerMax', minLevel: CapabilityLevel.advanced, label: 'Inner ring max'),
  PropertyMeta(key: 'innerColor', minLevel: CapabilityLevel.advanced, label: 'Inner ring colour'),
  PropertyMeta(key: 'innerArcWidth', minLevel: CapabilityLevel.advanced, label: 'Inner arc thickness'),
  PropertyMeta(key: 'redlineStart', minLevel: CapabilityLevel.advanced, label: 'Redline start (0-1)'),
  PropertyMeta(key: 'redlineColor', minLevel: CapabilityLevel.advanced, label: 'Redline colour'),
